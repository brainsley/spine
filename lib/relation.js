...
(function() {
  ...
  Collection = (function(_super) {
    ...
    Collection.prototype.refresh = function(values, options) {
  ...
  Singleton = (function(_super) {
    ...
    Singleton.prototype.update = function(value) {
      ...
      return value.save(this.saveOptions);
    };
  ...
  Spine.Model.extend({
    ...
    belongsTo: function(name, model, fkey, saveOptions) {
      var association;
      if (fkey == null) {
    ...
    hasOne: function(name, model, fkey, saveOptions) {
      var association;
      if (fkey == null) {
        fkey = "" + (underscore(this.className)) + "_id";
      }
